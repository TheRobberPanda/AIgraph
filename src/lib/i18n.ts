...
const en = {
  ...
  learn_toggle: "Learning mode",
  learn_hint: "Hand the app a finished document and read the ideas back out.",
  chat_placeholder_ready: "Start anywhere",
  chat_placeholder_connecting: "Connecting…",
  chat_placeholder_offline: "No model yet — write anyway, it sends once one is picked",
  chat_send_tip: "Send (Enter)",
  call_button_off: "Call mode — like a call with your ideas: short answers, read aloud",
  call_button_on: "Call mode on — like a call with your ideas: short answers, read aloud",
...
const pl: Partial<Record<Key, string>> = {
  ...
  tab_make: "Twórz",
  tab_learn: "Ucz się",
  tab_definitions: "Definicje",
  tab_settings: "Ustawienia",
  learn_toggle: "Tryb nauki",
  learn_hint: "Podaj gotowy dokument, a aplikacja odczyta z niego idee.",
  chat_placeholder_ready: "Zacznij od czegokolwiek",
  chat_placeholder_connecting: "Łączenie…",
  chat_placeholder_offline: "Nie ma jeszcze modelu — pisz, wiadomość wyśle się po wybraniu modelu",
  chat_send_tip: "Wyślij (Enter)",
  call_button_off: "Tryb rozmowy — jak rozmowa z twoimi pomysłami: krótkie odpowiedzi, czytane na głos",
  call_button_on: "Tryb rozmowy włączony — jak rozmowa z twoimi pomysłami: krótkie odpowiedzi, czytane na głos",
...
const es: Partial<Record<Key, string>> = {
  ...
  learn_toggle: "Modo aprender",
  learn_hint: "Entrega un documento terminado y la aplicación leerá las ideas.",
  chat_placeholder_ready: "Empieza por donde quieras",
  chat_placeholder_connecting: "Conectando…",
  chat_placeholder_offline: "Aún no hay modelo — escribe igual, se enviará al elegir uno",
  chat_send_tip: "Enviar (Intro)",
  call_button_off: "Modo llamada — como una llamada con tus ideas: respuestas breves, leídas en voz alta",
  call_button_on: "Modo llamada activado — como una llamada con tus ideas: respuestas breves, leídas en voz alta",
